...
STAGE_CONFIG = {
    ...
    3: {
        ...
        "script": "training/train_yolo_baseline.py",
        "args": ["--data", "data/dataset_aluminum.yaml", "--epochs", "150", "--batch", "4", "--imgsz", "800", "--name", "aluminum", "--lr", "0.001"],
        "estimated_minutes": 480,
    ...
    4: {
        ...
        "script": "training/train_yolo_baseline.py",
        "args": ["--data", "data/dataset_wood_10class.yaml", "--epochs", "150", "--batch", "4", "--imgsz", "800", "--name", "wood", "--lr", "0.001"],
