...
STAGE_CONFIG = {
    ...
    2: {
        ...
        "args": ["--data", "data/dataset.yaml", "--epochs", "150", "--batch", "16", "--imgsz", "640", "--name", "steel"],
    ...
    3: {
        "name": "Aluminum YOLO",
        "script": "training/train_yolo_baseline.py",
        "args": ["--data", "data/dataset_aluminum.yaml", "--epochs", "150", "--batch", "16", "--imgsz", "640", "--name", "aluminum", "--lr", "0.001"],
        "estimated_minutes": 45,
    ...
    4: {
        "name": "Wood YOLO",
        "script": "training/train_yolo_baseline.py",
        "args": ["--data", "data/dataset_wood.yaml", "--epochs", "150", "--batch", "16", "--imgsz", "640", "--name", "wood", "--lr", "0.001"],
