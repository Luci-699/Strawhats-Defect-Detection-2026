...
STAGE_CONFIG = {
    ...
    2: {
        ...
        "args": ["--data", "data/dataset.yaml", "--epochs", "150", "--batch", "4", "--imgsz", "640", "--name", "steel"],
        "estimated_minutes": 300,
        "description": "YOLOv10s on NEU-DET (6 defect classes) - saves to runs/steel/",
    },
    3: {
        "name": "Aluminum YOLO",
        "script": "training/train_yolo_baseline.py",
        "args": ["--data", "data/dataset_aluminum.yaml", "--epochs", "150", "--batch", "4", "--imgsz", "640", "--name", "aluminum", "--lr", "0.001"],
        "estimated_minutes": 300,
        "description": "YOLOv10s on Aluminum Defects (10 classes, lr=0.001) - saves to runs/aluminum/",
    },
    4: {
        "name": "Wood YOLO",
        "script": "training/train_yolo_baseline.py",
