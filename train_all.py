...
STAGE_CONFIG = {
    ...
    2: {
        ...
        "args": ["--data", "data/processed/steel_unified/dataset.yaml", "--epochs", "150", "--batch", "4", "--imgsz", "800", "--name", "steel"],
        "estimated_minutes": 480,
        "description": "YOLOv10m on Unified Steel (15 classes, 150ep, imgsz=800, mixup+copy_paste) - target >85% mAP50",
    },
    3: {
        "name": "Aluminum YOLO v2 (3k-subset, 100ep)",
        "script": "training/train_yolo_baseline.py",
        "args": ["--data", "data/dataset_aluminum_3k.yaml", "--epochs", "100", "--batch", "4", "--imgsz", "800", "--name", "aluminum", "--lr", "0.001"],
        "estimated_minutes": 300,
        "description": "YOLOv10m on Aluminum Defects (10 classes, 3k subset, 100ep, imgsz=800) - target >68% mAP50",
    },
    4: {
        "name": "Wood YOLO v2 (3k-subset, 100ep)",
        "script": "training/train_yolo_baseline.py",
        "args": ["--data", "data/dataset_wood_3k.yaml", "--epochs", "100", "--batch", "4", "--imgsz", "800", "--name", "wood", "--lr", "0.001"],
        "estimated_minutes": 300,
    ...
    6: {
        ...
        "script": "training/train_morphology_fusion.py",
        "args": ["--material", "aluminum", "--data", "data/dataset_aluminum_3k.yaml", "--batch", "8", "--epochs", "100"],
        "estimated_minutes": 300,
    ...
    7: {
        ...
        "script": "training/train_morphology_fusion.py",
        "args": ["--material", "wood", "--data", "data/dataset_wood_3k.yaml", "--batch", "8", "--epochs", "100"],
        "estimated_minutes": 300,
...
|   Dataset: ~20,800 images across 3 materials                 |
|                                                              |
